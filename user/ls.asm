...
00000000000005b8 <recv>:
.global recv
recv:
 li a7, SYS_recv
 5b8:	02000893          	li	a7,32
 ecall
 5bc:	00000073          	ecall
 ret
 5c0:	8082                	ret

00000000000005c2 <pgpte>:
.global pgpte
pgpte:
 li a7, SYS_pgpte
...
00000000000005cc <kpgtbl>:
.global kpgtbl
kpgtbl:
 li a7, SYS_kpgtbl
 5cc:	02200893          	li	a7,34
 ecall
 5d0:	00000073          	ecall
 ret
 5d4:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 602:	0805c363          	bltz	a1,688 <printint+0x94>
  neg = 0;
 606:	4881                	li	a7,0
 ...
 612:	56a50513          	addi	a0,a0,1386 # b78 <digits>
 616:	883e                	mv	a6,a5
 ...
 630:	fec773e3          	bgeu	a4,a2,616 <printint+0x22>
  if(neg)
 634:	00088b63          	beqz	a7,64a <printint+0x56>
    buf[i++] = '-';
 ...
 646:	0028079b          	addiw	a5,a6,2
  ...
  while(--i >= 0)
 64a:	02f05a63          	blez	a5,67e <printint+0x8a>
 64e:	fc26                	sd	s1,56(sp)
 650:	f44e                	sd	s3,40(sp)
 652:	fb840713          	addi	a4,s0,-72
 656:	00f704b3          	add	s1,a4,a5
 65a:	fff70993          	addi	s3,a4,-1
 65e:	99be                	add	s3,s3,a5
 660:	37fd                	addiw	a5,a5,-1
 662:	1782                	slli	a5,a5,0x20
 664:	9381                	srli	a5,a5,0x20
 666:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
 66a:	fff4c583          	lbu	a1,-1(s1)
 66e:	854a                	mv	a0,s2
 670:	f67ff0ef          	jal	5d6 <putc>
  while(--i >= 0)
 674:	14fd                	addi	s1,s1,-1
 676:	ff349ae3          	bne	s1,s3,66a <printint+0x76>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 78e:	855a                	mv	a0,s6
 790:	e47ff0ef          	jal	5d6 <putc>
        putc(fd, c0);
 794:	85ca                	mv	a1,s2
 796:	855a                	mv	a0,s6
 798:	e3fff0ef          	jal	5d6 <putc>
      state = 0;
 79c:	4981                	li	s3,0
 ...
 892:	855a                	mv	a0,s6
 894:	d43ff0ef          	jal	5d6 <putc>
  putc(fd, 'x');
 898:	07800593          	li	a1,120
 89c:	855a                	mv	a0,s6
 89e:	d39ff0ef          	jal	5d6 <putc>
 8a2:	4941                	li	s2,16
