...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	22e58593          	addi	a1,a1,558 # 1240 <malloc+0x100>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	1fc58593          	addi	a1,a1,508 # 1250 <malloc+0x110>
      5c:	4509                	li	a0,2
      5e:	004010ef          	jal	1062 <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	1d650513          	addi	a0,a0,470 # 1258 <malloc+0x118>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	2ae70713          	addi	a4,a4,686 # 1358 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      c6:	19e50513          	addi	a0,a0,414 # 1260 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	18c58593          	addi	a1,a1,396 # 1268 <malloc+0x128>
      e4:	4509                	li	a0,2
      e6:	77d000ef          	jal	1062 <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	16858593          	addi	a1,a1,360 # 1278 <malloc+0x138>
     118:	4509                	li	a0,2
     11a:	749000ef          	jal	1062 <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	11650513          	addi	a0,a0,278 # 1288 <malloc+0x148>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	de4a8a93          	addi	s5,s5,-540 # 12b0 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	db250513          	addi	a0,a0,-590 # 1290 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d1e60613          	addi	a2,a2,-738 # 12b8 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d0eb0b13          	addi	s6,s6,-754 # 12d8 <malloc+0x198>
  ...
  return ret;
     ...
     5f8:	ccc50513          	addi	a0,a0,-820 # 12c0 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c8250513          	addi	a0,a0,-894 # 12c8 <malloc+0x188>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c5c60613          	addi	a2,a2,-932 # 12e0 <malloc+0x1a0>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c08a0a13          	addi	s4,s4,-1016 # 12e8 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	be660613          	addi	a2,a2,-1050 # 12f0 <malloc+0x1b0>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b5860613          	addi	a2,a2,-1192 # 12b8 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b8460613          	addi	a2,a2,-1148 # 1308 <malloc+0x1c8>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b3e50513          	addi	a0,a0,-1218 # 12f8 <malloc+0x1b8>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b4a50513          	addi	a0,a0,-1206 # 1310 <malloc+0x1d0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b8270713          	addi	a4,a4,-1150 # 1370 <malloc+0x230>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	9ce60613          	addi	a2,a2,-1586 # 1248 <malloc+0x108>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a8058593          	addi	a1,a1,-1408 # 1328 <malloc+0x1e8>
     8b0:	4509                	li	a0,2
     8b2:	7b0000ef          	jal	1062 <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a0a50513          	addi	a0,a0,-1526 # 12c0 <malloc+0x180>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	a6248493          	addi	s1,s1,-1438 # 1338 <malloc+0x1f8>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	9c658593          	addi	a1,a1,-1594 # 1340 <malloc+0x200>
     982:	4509                	li	a0,2
     984:	6de000ef          	jal	1062 <fprintf>
...
0000000000000ce6 <recv>:
.global recv
recv:
 li a7, SYS_recv
     ce6:	02000893          	li	a7,32
 ecall
     cea:	00000073          	ecall
 ret
     cee:	8082                	ret

0000000000000cf0 <pgpte>:
.global pgpte
pgpte:
 li a7, SYS_pgpte
     cf0:	02100893          	li	a7,33
 ecall
     cf4:	00000073          	ecall
 ret
     cf8:	8082                	ret

0000000000000cfa <kpgtbl>:
.global kpgtbl
kpgtbl:
 li a7, SYS_kpgtbl
     cfa:	02200893          	li	a7,34
 ecall
     cfe:	00000073          	ecall
 ret
     d02:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     d30:	0805c363          	bltz	a1,db6 <printint+0x94>
  neg = 0;
     d34:	4881                	li	a7,0
     d36:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     d3c:	00000517          	auipc	a0,0x0
     d40:	64c50513          	addi	a0,a0,1612 # 1388 <digits>
     d44:	883e                	mv	a6,a5
     d46:	2785                	addiw	a5,a5,1
     d48:	02c5f733          	remu	a4,a1,a2
     d4c:	972a                	add	a4,a4,a0
     d4e:	00074703          	lbu	a4,0(a4)
     d52:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     d56:	872e                	mv	a4,a1
     d58:	02c5d5b3          	divu	a1,a1,a2
     d5c:	0685                	addi	a3,a3,1
     d5e:	fec773e3          	bgeu	a4,a2,d44 <printint+0x22>
  if(neg)
     d62:	00088b63          	beqz	a7,d78 <printint+0x56>
    buf[i++] = '-';
     d66:	fd078793          	addi	a5,a5,-48
     d6a:	97a2                	add	a5,a5,s0
     d6c:	02d00713          	li	a4,45
     d70:	fee78423          	sb	a4,-24(a5)
     d74:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     d78:	02f05a63          	blez	a5,dac <printint+0x8a>
     d7c:	fc26                	sd	s1,56(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ebc:	855a                	mv	a0,s6
     ebe:	e47ff0ef          	jal	d04 <putc>
        putc(fd, c0);
     ec2:	85ca                	mv	a1,s2
     ec4:	855a                	mv	a0,s6
     ec6:	e3fff0ef          	jal	d04 <putc>
      state = 0;
     eca:	4981                	li	s3,0
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1032:	bbd9                	j	e08 <vprintf+0x4a>
          s = "(null)";
    1034:	00000917          	auipc	s2,0x0
    1038:	31c90913          	addi	s2,s2,796 # 1350 <malloc+0x210>
        for(; *s; s++)
    ...
    10f4:	00e6ea63          	bltu	a3,a4,1108 <free+0x4a>
{
  ...
  freep = p;
    ...
    1136:	ecf73f23          	sd	a5,-290(a4) # 2010 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1160:	eb453503          	ld	a0,-332(a0) # 2010 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    118c:	00001917          	auipc	s2,0x1
    1190:	e8490913          	addi	s2,s2,-380 # 2010 <freep>
  if(p == SBRK_ERROR)
    1194:	5afd                	li	s5,-1
