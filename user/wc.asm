...
00000000000004a8 <recv>:
.global recv
recv:
 li a7, SYS_recv
 4a8:	02000893          	li	a7,32
 ecall
 4ac:	00000073          	ecall
 ret
 4b0:	8082                	ret

00000000000004b2 <pgpte>:
.global pgpte
pgpte:
 li a7, SYS_pgpte
 4b2:	02100893          	li	a7,33
 ecall
 4b6:	00000073          	ecall
 ret
 4ba:	8082                	ret

00000000000004bc <kpgtbl>:
.global kpgtbl
kpgtbl:
 li a7, SYS_kpgtbl
 4bc:	02200893          	li	a7,34
 ecall
 4c0:	00000073          	ecall
 ret
 4c4:	8082                	ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 502:	55250513          	addi	a0,a0,1362 # a50 <digits>
 506:	883e                	mv	a6,a5
