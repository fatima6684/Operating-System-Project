...
0000000000000c2a <recv>:
.global recv
recv:
 li a7, SYS_recv
     c2a:	02000893          	li	a7,32
 ecall
     c2e:	00000073          	ecall
 ret
     c32:	8082                	ret

0000000000000c34 <pgpte>:
.global pgpte
pgpte:
 li a7, SYS_pgpte
     c34:	02100893          	li	a7,33
 ecall
     c38:	00000073          	ecall
 ret
     c3c:	8082                	ret

0000000000000c3e <kpgtbl>:
.global kpgtbl
kpgtbl:
 li a7, SYS_kpgtbl
     c3e:	02200893          	li	a7,34
 ecall
     c42:	00000073          	ecall
 ret
     c46:	8082                	ret

0000000000000c48 <putc>:
...
putc(int fd, char c)
{
     ...
     c50:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     c54:	4605                	li	a2,1
     c56:	fef40593          	addi	a1,s0,-17
     c5a:	f39ff0ef          	jal	b92 <write>
}
...
{
     c66:	715d                	addi	sp,sp,-80
     c68:	e486                	sd	ra,72(sp)
     c6a:	e0a2                	sd	s0,64(sp)
     c6c:	f84a                	sd	s2,48(sp)
     c6e:	0880                	addi	s0,sp,80
     c70:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  if(sgn && xx < 0){
     ...
     c74:	0805c363          	bltz	a1,cfa <printint+0x94>
  neg = 0;
     c78:	4881                	li	a7,0
     c7a:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     c84:	87050513          	addi	a0,a0,-1936 # 14f0 <digits>
     c88:	883e                	mv	a6,a5
     c8a:	2785                	addiw	a5,a5,1
     c8c:	02c5f733          	remu	a4,a1,a2
     c90:	972a                	add	a4,a4,a0
     c92:	00074703          	lbu	a4,0(a4)
     c96:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     c9a:	872e                	mv	a4,a1
     c9c:	02c5d5b3          	divu	a1,a1,a2
     ca0:	0685                	addi	a3,a3,1
     ca2:	fec773e3          	bgeu	a4,a2,c88 <printint+0x22>
  if(neg)
     ca6:	00088b63          	beqz	a7,cbc <printint+0x56>
    buf[i++] = '-';
     caa:	fd078793          	addi	a5,a5,-48
     cae:	97a2                	add	a5,a5,s0
     cb0:	02d00713          	li	a4,45
     cb4:	fee78423          	sb	a4,-24(a5)
     cb8:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     cbc:	02f05a63          	blez	a5,cf0 <printint+0x8a>
     cc0:	fc26                	sd	s1,56(sp)
     cc2:	f44e                	sd	s3,40(sp)
     cc4:	fb840713          	addi	a4,s0,-72
     cc8:	00f704b3          	add	s1,a4,a5
     ccc:	fff70993          	addi	s3,a4,-1
     cd0:	99be                	add	s3,s3,a5
     cd2:	37fd                	addiw	a5,a5,-1
     cd4:	1782                	slli	a5,a5,0x20
     cd6:	9381                	srli	a5,a5,0x20
     cd8:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     cdc:	fff4c583          	lbu	a1,-1(s1)
     ce0:	854a                	mv	a0,s2
     ce2:	f67ff0ef          	jal	c48 <putc>
  while(--i >= 0)
     ce6:	14fd                	addi	s1,s1,-1
     ce8:	ff349ae3          	bne	s1,s3,cdc <printint+0x76>
     ...
     cf8:	8082                	ret
    x = -xx;
     cfa:	40b005b3          	neg	a1,a1
    neg = 1;
     cfe:	4885                	li	a7,1
    x = -xx;
     d00:	bfad                	j	c7a <printint+0x14>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     e00:	855a                	mv	a0,s6
     e02:	e47ff0ef          	jal	c48 <putc>
        putc(fd, c0);
     e06:	85ca                	mv	a1,s2
     e08:	855a                	mv	a0,s6
     e0a:	e3fff0ef          	jal	c48 <putc>
      state = 0;
     e0e:	4981                	li	s3,0
  ...
  putc(fd, '0');
     ...
     f04:	855a                	mv	a0,s6
     f06:	d43ff0ef          	jal	c48 <putc>
  putc(fd, 'x');
     f0a:	07800593          	li	a1,120
     f0e:	855a                	mv	a0,s6
     f10:	d39ff0ef          	jal	c48 <putc>
     f14:	4941                	li	s2,16
